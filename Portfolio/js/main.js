...
document.getElementById("resume-button-1").onclick = () => {
    window.open("https://drive.google.com/file/d/1w0n2wIiEtMhLH3p-UVF5qkXVaLRajnt-/view?usp=sharing");
}

document.getElementById("resume-button-2").onclick = () => {
    location.assign("https://drive.google.com/file/d/1w0n2wIiEtMhLH3p-UVF5qkXVaLRajnt-/view?usp=sharing");
}
